...
for location in items:
    ...
    for month_relative in results[f'{items[location_index]['Location']}']['relative_monthly_precipitation']:
        current_month += 1
        results[f'{items[location_index]['Location']}']['relative_monthly_precipitation'][current_month] = int(results[f'{items[location_index]['Location']}']['total_monthly_precipitation'][current_month]) / total_yearly_precipitation
